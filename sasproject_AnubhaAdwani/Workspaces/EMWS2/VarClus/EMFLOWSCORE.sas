...
Clus33 = Clus33+0.53528921165148 * (ACTBUY - 0.99109663409337)/1.16003174926523;
Clus7 = Clus7+0.35202500759828 * (BUYPROP - 0.18928931964407)/0.25656954904129;
Clus1 = Clus1+0.13961478444576 * (CATALOGCNT - 3.77161470451372)/3.12899556544539;
Clus27 = Clus27+-0.05699292569275 * (COUNTY - 429.243089809213)/315.885470720057;
Clus3 = Clus3+0.2537672761045 * (DAYLAST - 1182.17608189855)/1226.0780195912;
...
Clus30 = Clus30+0.21799066207907 * (DEPT07 - 0.02559329920893)/0.31536747776311;
Clus30 = Clus30+0.33993271338746 * (DEPT08 - 0.31512331316891)/1.29408639394269;
Clus30 = Clus30+0.34186033539386 * (DEPT09 - 0.2486427795874)/1.20923480324609;
Clus30 = Clus30+0.35421920019149 * (DEPT10 - 0.39066232356134)/1.7648701612552;
Clus30 = Clus30+0.28393608567866 * (DEPT11 - 0.15141926477431)/0.76300583506574;
Clus30 = Clus30+0.38386073638767 * (DEPT12 - 0.21448735846129)/0.89341788675275;
...
Clus34 = Clus34+0.55584809459247 * (DEPT18 - 0.1317512021095)/0.70116887678934;
Clus34 = Clus34+0.47715127706675 * (DEPT19 - 0.07324336900884)/0.59281735227563;
Clus34 = Clus34+0.46283809727038 * (DEPT20 - 0.02956413835892)/0.31025698407933;
Clus34 = Clus34+0.38062270827744 * (DEPT21 - 0.01821002016441)/0.24509272697267;
Clus1 = Clus1+0.11270007233835 * (DEPT22 - 2.12771831859779)/3.55134640550257;
Clus31 = Clus31+0.60605266548224 * (DEPT23 - 2.14223669923995)/3.81941288304535;
Clus31 = Clus31+0.60605266548224 * (DEPT24 - 0.64039087947882)/1.70711269742472;
Clus33 = Clus33+0.50095253643032 * (DEPT25 - 1.77676438653637)/4.75421718243184;
Clus33 = Clus33+0.3504278421353 * (DEPT26 - 0.19075539010392)/0.91270742425277;
Clus1 = Clus1+0.07540932251311 * (DEPT27 - 0.58712579494338)/1.55259848403997;
Clus9 = Clus9+0.50586446117948 * (DOLINDEA - 47.8585866898046)/37.591191668842;
Clus1 = Clus1+0.14866842285081 * (DOLINDET - 197.869031487513)/314.244548218948;
Clus5 = Clus5+0.34464480939946 * (DOLL24 - 45.4938073522568)/93.9875146751151;
...
Clus12 = Clus12+0.53251837592186 * (DOLLARQ03 - 2.77052582596555)/15.8095808048519;
Clus17 = Clus17+0.53398718553838 * (DOLLARQ04 - 4.67856274236079)/22.181986153492;
Clus18 = Clus18+0.53548666653293 * (DOLLARQ05 - 4.32741461144718)/21.5182033567075;
...
Clus27 = Clus27+0.53886797101639 * (DOLLARQ08 - 6.15043803319373)/27.3333023843591;
Clus22 = Clus22+0.5349541071483 * (DOLLARQ09 - 4.29424383434155)/20.7683103640237;
Clus11 = Clus11+0.53279724233879 * (DOLLARQ10 - 3.64839584302776)/18.9957061824675;
Clus15 = Clus15+0.53532885078822 * (DOLLARQ11 - 4.15352411974561)/20.8177653006881;
Clus6 = Clus6+0.53743395102358 * (DOLLARQ12 - 6.39860555297037)/27.403980773023;
Clus26 = Clus26+0.54383527719424 * (DOLLARQ13 - 5.38680471537149)/25.9110809016436;
Clus19 = Clus19+0.54398954027119 * (DOLLARQ14 - 4.43791499922444)/23.752188577194;
Clus8 = Clus8+0.53531614157592 * (DOLLARQ15 - 4.90567023421746)/23.5349065932921;
Clus5 = Clus5+0.43526902239583 * (DOLLARQ16 - 7.79008624166279)/31.0104071776129;
Clus21 = Clus21+0.54023917839594 * (DOLLARQ17 - 5.57017403443462)/26.1415799982751;
Clus14 = Clus14+0.53306278493927 * (DOLLARQ18 - 4.78568140220257)/22.3927978593641;
Clus16 = Clus16+0.53462067704059 * (DOLLARQ19 - 4.33358802543818)/21.704742358276;
Clus7 = Clus7+0.39991268188088 * (DOLLARQ20 - 8.71046657360012)/32.6472704396303;
Clus20 = Clus20+0.53908041935557 * (DOLLARQ21 - 4.7463651310687)/24.268088572003;
Clus10 = Clus10+0.53808320116509 * (DOLLARQ22 - 4.88413153404684)/24.8521912523649;
Clus9 = Clus9+0.50586446117948 * (DOLNETDA - 45.411597554134)/36.1502695431938;
Clus1 = Clus1+0.14795449132882 * (DOLNETDT - 189.18095548317)/303.615750735173;
Clus3 = Clus3+-0.25376903799683 * (DTBUYLST - 16579.2557778811)/1226.01924677542;
Clus1 = Clus1+0.13748025428471 * (FREQPRCH - 4.18160384675042)/5.31459540671444;
Clus3 = Clus3+0.2537631405367 * (MONLAST - 38.7579959671164)/40.2783526824403;
Clus3 = Clus3+0.14359952723091 * (TENURE - 83.4682798200713)/60.0499642836247;
...
Clus12 = Clus12+0.53251837592187 * (TOTORDQ03 - 0.05841476655808)/0.25663649019308;
Clus17 = Clus17+0.53398718553838 * (TOTORDQ04 - 0.09058476810919)/0.33923460400983;
Clus18 = Clus18+0.53548666653293 * (TOTORDQ05 - 0.08766868310842)/0.32373427535999;
...
Clus27 = Clus27+0.53926414531435 * (TOTORDQ08 - 0.11782224290367)/0.39692742169452;
Clus22 = Clus22+0.5349541071483 * (TOTORDQ09 - 0.09120521172638)/0.32676782706381;
Clus11 = Clus11+0.53279724233879 * (TOTORDQ10 - 0.07501163331782)/0.2991488551838;
Clus15 = Clus15+0.53532885078822 * (TOTORDQ11 - 0.08630370715061)/0.31791570298113;
Clus6 = Clus6+0.53743395102358 * (TOTORDQ12 - 0.12619823173569)/0.4074226605598;
Clus26 = Clus26+0.54383527719424 * (TOTORDQ13 - 0.10832945556072)/0.35251925488707;
Clus19 = Clus19+0.54398954027119 * (TOTORDQ14 - 0.08894059252365)/0.31938115502111;
Clus8 = Clus8+0.53531614157592 * (TOTORDQ15 - 0.09821622460058)/0.342400248125;
Clus5 = Clus5+0.41150425358848 * (TOTORDQ16 - 0.14620753838994)/0.42506049526083;
Clus21 = Clus21+0.54023917839594 * (TOTORDQ17 - 0.108267411199)/0.35925036974258;
Clus14 = Clus14+0.53306278493927 * (TOTORDQ18 - 0.09319063130138)/0.32753587031264;
Clus16 = Clus16+0.53462067704059 * (TOTORDQ19 - 0.08217775709632)/0.30645832771871;
Clus7 = Clus7+0.42523270759691 * (TOTORDQ20 - 0.15985729796804)/0.46170113594525;
Clus20 = Clus20+0.53908041935557 * (TOTORDQ21 - 0.09182565534357)/0.32980785722872;
Clus10 = Clus10+0.53808320116509 * (TOTORDQ22 - 0.08611757406545)/0.31443413012517;
Clus1 = Clus1+0.14704520640825 * (UNITSIDD - 10.9602916085)/17.1055734908767;
Clus32 = Clus32+0.63553074921092 * (UNITSLAP - 22.0808611006276)/19.5877886329162;
Clus32 = Clus32+-0.63553074921092 * (UNTLANPO - 2.67912081406979)/2.42439611488132;
...
Clus3 = Clus3+0.21207647949245 * (METHPAYMDK - 0.08655188459748)/0.28118162916549;
